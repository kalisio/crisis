...
import { Events } from '@kalisio/kdk/core/client/events.js'
import { useCollection } from '@kalisio/kdk/core/client/composables/index.js'
import { loadComponent } from '@kalisio/kdk/core/client/utils/index.js'
